...
public class AdapterLaundry extends RecyclerView.Adapter<AdapterLaundry.MyViewHolder>{
    ...
    public AdapterLaundry(Context context, ArrayList<ModelLaundry> LaundryArraylist) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdapterLaundry.MyViewHolder(v);
    }
       ...
       // String currentid = user1.getUid();
        ...
        holder.btn_info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("jarak", holder.txt_jarak.getText().toString()+ " Km");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            txt_jarak = itemView.findViewById(R.id.Jarak_text_lokasi);
        }
    }
}
